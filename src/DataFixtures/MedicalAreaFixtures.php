...
{
    public const HOSPITAL_LAVAL_REFERENCE = "medical-area-type-hospital-laval";
    public const OFFICE_LOUVERNE_REFERENCE = "medical-area-type-office-louverne";
    public const OFFICE_RENNES_REFERENCE = "medical-area-type-office-rennes";
